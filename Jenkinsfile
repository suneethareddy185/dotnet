...
//     }
   ...
   stage('Docker build and push') {
	 ...
	 echo $secret_key
         ...
         docker login -u AWS -p $DOCKER_LOGIN_PASSWORD 728854731024.dkr.ecr.ap-south-1.amazonaws.com
	 docker build -t 728854731024.dkr.ecr.ap-south-1.amazonaws.com/reddy:SAMPLE-PROJECT-${BUILD_NUMBER} .
	 docker push 728854731024.dkr.ecr.ap-south-1.amazonaws.com/reddy:SAMPLE-PROJECT-${BUILD_NUMBER}
